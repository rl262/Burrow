...
> ⚠️ **Status: alpha (`v0.1.0-alpha.2`) — validated on Ubuntu 24.04.** Test on a throwaway VM before pointing real clients at it.
...
```bash
curl -fsSL https://raw.githubusercontent.com/rl262/Burrow/v0.1.0-alpha.2/install.sh -o /tmp/burrow-install.sh && sudo bash /tmp/burrow-install.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/rl262/Burrow/v0.1.0-alpha.2/install.sh | sudo bash
```
