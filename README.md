...
See [ROADMAP.md](ROADMAP.md) for planned work — secondary/failover, persistent query stats, per-client groups, "pause blocking", regex rules, arm64, backup/restore, Authentik SSO, and more.
